// Gaming sales between NA_Sales,EU_Sales,JP_Sales (Area Chart)
class AreaChart {
  constructor(_data, _posX, _posY, _chartWidth, _chartHeight, _barWidth) {
    this.data = _data;
    this.cleanedData = [];
    this.yValues = [];
    this.yValue = "NA_Sales";
    this.binValues = [];
    this.binRange;
    this.numBins = 5;
    this.rangeMin;
    ...
    this.posX = _posX;
    this.posY = _posY;
    this.convertInts = ["NA_Sales", "EU_Sales", "JP_Sales"];
  ...
  drawLabels() {
    ...
    textAlign(CENTER);
    text("Area Chart", this.chartWidth / 2, -this.chartHeight - 25);
